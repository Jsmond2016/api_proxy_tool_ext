...
- **components:** 禁用按钮改为始终激活状态，无数据时点击弹出提示 ([638f90d](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/638f90dd114b3efc176d6fc5ad11f3ede7a4f7f8))

## [1.5.39](https://github.com/Jsmond2016/api_proxy_tool_ext/compare/v1.5.37...v1.5.39) (2026-07-04)

### Features

- 版本信息末尾追加发布日期 ([9655a32](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/9655a32132b34c00081dc985c95b6be756bccb39))

## [1.5.37](https://github.com/Jsmond2016/api_proxy_tool_ext/compare/v1.5.36...v1.5.37) (2026-07-02)
...
## [1.5.36](https://github.com/Jsmond2016/api_proxy_tool_ext/compare/v1.5.33...v1.5.36) (2026-07-02)

### Chores

- Bump version to v1.5.35 ([58b623f](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/58b623f404cc339bba8346af50a1f3ad8df346c6))
- Bump version to v1.5.34 ([956c186](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/956c1863fbf4dadd114cbc172f877af685b1d624))

### Styles

- 排序图标右对齐避免误触 Switch ([e1108f6](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/e1108f67b7c01112dc6c62ff31a0e23112b250d7))
- 统一请求方式 Tag 尺寸并增加 hover 提示 ([040bb0f](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/040bb0ffd6181b4531b5e15bb0228ca4c23c225b))
- 开关列左对齐与表头保持一致 ([6e9b314](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/6e9b314ea5fb411d2bfb6e06a1a68f006394e44b))
- 缩小弹框提示文字大小 ([d2affe5](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/d2affe5a613f6d6ef967d5ca88dc895ccab35d09))

### Bug Fixes

- 开关列排序由整列头触发改为仅点击排序图标触发 ([3ae983c](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/3ae983c62cc54f508b9edafc5114767b3e620286))
- 全部接口 tab 去掉默认按开关排序，改为手动排序 ([b7b7ea3](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/b7b7ea379fab664978ee6d55c0c12506d8c1af03))
- 弹框加载时过滤本地模式的 apifoxUrl 不污染项目编号 ([c9dd139](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/c9dd139794eae9610a54d31c8153921753687b07))
- 本地模式强制使用 MOCK_PREFIX_LOCAL 避免混入云端 mock 地址 ([40c5d11](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/40c5d1111ef437f3df878f6059c095cfd71c55e0))
- 切换本地/云端模式时 mockPrefix 不再误用另一模式的值 ([4a6f35e](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/4a6f35ec5c25066e61a9e844dd5ed08ef94fa864))
- 切换云端/本地模式时保留表单字段值不丢失 ([71c8e58](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/71c8e58662cda44c8ef13330312085c90687eefb))
- 在线模式文案统一改为云端模式，模式指示器移至全局开关左侧 ([addd0ec](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/addd0ec435ac2f08d3eb457d6e85c7a3afdab309))

### Features

- 请求方式连续点击3次触发仅单个调试 ([860ae73](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/860ae734662ddb188b9d591050fa946f1cab9f5a))
- 测试按钮全局开关未开时弹窗提供两个选项 ([6371f86](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/6371f86df9de2ad9849e7a6ca2eef66e6c13e4fe))
- 顶部栏和 Popup 增加 Apifox 模式指示器 ([5d00f77](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/5d00f77e3afd6fb12e22afd73d4a003bc491a651))
- 新增 Apifox Mock 令牌字段，修复在线/本地模式切换相关 bug ([1d6b62d](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/1d6b62dc68cf07099e8862b1cda724a3323cad03))
- 新增「全部接口」聚合 Tab ([905c992](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/905c992dc512151c1f8415761e368403fba8fcc8))

### Code Refactoring

- 移除本地模式，仅保留云端模式 ([eff2369](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/eff2369bbe76d44f65bc46a42292aa49a6e8e3a4))
- 重构 Apifox 配置按钮，提取迭代信息按钮到导航栏 ([eef3ac0](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/eef3ac0ffed27317b6e6f824cd01aa1cd48d3eb9))

## [1.5.33](https://github.com/Jsmond2016/api_proxy_tool_ext/compare/v1.5.32...v1.5.33) (2026-06-15)
...
- **components:** 增加复制信息预览确认弹窗和 CR 联动预览 ([6c08882](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/6c08882ce988436a73bfe848b1bc664030de7de9))
...
- 修正 README 中已废弃和未实现的功能描述 ([1794f85](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/1794f858b2c9ab5d27334b7d33bd8a28de4faf7d))
- 重写中英文 README，全面更新项目功能描述 ([44d6eb9](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/44d6eb91d758ee114d83038468f858e9ed026c68))
- 重写 CHANGELOG.md，去除重复和旧 fork 版本历史 ([f7af4d4](https://github.com/Jsmond2016/api_proxy_tool_ext/commit/f7af4d4f1c107e6ef9fd41b5a25fbbb194fad369))
