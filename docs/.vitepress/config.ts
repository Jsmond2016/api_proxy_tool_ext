...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '用户指南', link: '/guide/getting-started', activeMatch: '^/guide/' },
      { text: '开发指南', link: '/developer-guide/', activeMatch: '^/developer-guide/' },
      { text: '架构设计', link: '/architecture/', activeMatch: '^/architecture/' },
      { text: '接口文档', link: '/api-reference/', activeMatch: '^/api-reference/' },
      { text: '发布指南', link: '/publishing/', activeMatch: '^/publishing/' },
      ...
      '/api-reference/': [
        {
          ...
          items: [
            ...
            { text: '跨插件批量 QuickMock 联调', link: '/api-reference/quick-mock-debug' },
          ],
        },
      ],
      ...
      '/changelog/': [
        {
          ...
          items: [
            ...
            { text: 'Changelog 自动化方案', link: '/changelog/automation-summary' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Jsmond2016/api_proxy_tool_ext' },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/Jsmond2016/api_proxy_tool_ext/edit/main/docs/:path',
      text: '在 GitHub 上编辑此页',
    },
  },
})
