---
title: 发布流程
description: API Proxy Tool 的自动化 CI/CD 发布流程指南
outline: deep
---
...
1. Go to [GitHub Actions](https://github.com/Jsmond2016/api_proxy_tool_ext/actions)
...
- Check [GitHub Actions](https://github.com/Jsmond2016/api_proxy_tool_ext/actions) for workflow status
